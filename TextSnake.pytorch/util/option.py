...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--viz_save_iter', default=30000, type=int, help='visualize training process every # iterations')
        self.parser.add_argument('--save_freq', default=1, type=int, help='save weights every # epoch')
